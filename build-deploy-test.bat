...
set "PROJECT_DIR=%~dp0"
set "TEST_INSTANCE=C:\Users\lauya\curseforge\minecraft\Instances\JPCreate2.5"
set "TEST_MODS=%TEST_INSTANCE%\mods"
set "VS23_REF=C:\Modding\Reference mod VS2.3"
...
call gradlew.bat build "-Pvs23_reference_mods_dir=%VS23_REF%" --console=plain
if errorlevel 1 (
