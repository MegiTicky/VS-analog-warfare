...
public final class DbwCompat {
    ...
    @Nullable public static String linkBackups(Level level, BlockPos source, BlockPos target) {
        ...
        try {
            ...
            if (sourceBackup == null || !sourceBackup.getClass().getName().equals("edn.stratodonut.drivebywire.blocks.WireNetworkBackupBlockEntity")) return "source is not a DBW backup block";
