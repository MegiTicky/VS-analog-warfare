...
public final class VehicleSetupAction {
    ...
    private VehicleSetupAction(VehicleSetupActionType type, @Nullable BlockPos targetOffset,
                               ...
                               long targetShipId, long secondaryShipId, @Nullable CompoundTag blockState,
                               @Nullable CompoundTag controller, float stiffness,
        ...
        this(type, targetOffset, secondaryOffset, shipOffset, targetShipId, secondaryShipId, blockState,
                controller, stiffness, positionOffsetX, positionOffsetY, positionOffsetZ, interactionItem,
                interactionHand, interactionFace, interactionSneaking, 0, null);
    }
    ...
    private VehicleSetupAction(VehicleSetupActionType type, @Nullable BlockPos targetOffset,
                               ...
                               @Nullable CompoundTag controller, float stiffness) {
        this(type, targetOffset, secondaryOffset, shipOffset, targetShipId, secondaryShipId, blockState,
                controller, stiffness, 0.0, 0.0, 0.0, null, 0, 0, false, 0, null);
    }
    ...
    public static VehicleSetupAction removeBlock(long shipId, @Nullable BlockPos shipOffset,
    ...
    public static VehicleSetupAction createTweakedController(long shipId, BlockPos hubOffset,
    ...
    public static VehicleSetupAction setTrackworkStiffness(float stiffness) {
        return new VehicleSetupAction(VehicleSetupActionType.SET_TRACKWORK_STIFFNESS, null, null, null,
                -1L, -1L, null, null, stiffness);
    }
    ...
    public static VehicleSetupAction interactWithBlock(long shipId, @Nullable BlockPos shipOffset,
        ...
        return new VehicleSetupAction(VehicleSetupActionType.GENERIC_BLOCK_INTERACTION, anchorOffset, null, shipOffset,
                shipId, -1L, null, null, 0.0f, hitOffset.x, hitOffset.y, hitOffset.z,
                item.save(new CompoundTag()), hand.ordinal(), face.ordinal(), sneaking);
    }
    ...
    public static VehicleSetupAction leftClickBlock(long shipId, @Nullable BlockPos shipOffset,
        ...
        return new VehicleSetupAction(VehicleSetupActionType.GENERIC_BLOCK_LEFT_CLICK, anchorOffset, null, shipOffset,
                shipId, -1L, null, null, 0.0f, 0.5, 0.5, 0.5,
                item.save(new CompoundTag()), InteractionHand.MAIN_HAND.ordinal(), face.ordinal(), sneaking);
    }
    ...
    public static VehicleSetupAction configureEnderTransmitter(long shipId, BlockPos shipOffset,
        ...
        return new VehicleSetupAction(VehicleSetupActionType.CONFIGURE_ENDER_TRANSMITTER, anchorOffset, null,
                shipOffset, shipId, -1L, null, null, 0.0f, 0.0, 0.0, 0.0, null, 0, 0, false,
                channel, password);
    }
    ...
    public static VehicleSetupAction load(CompoundTag tag) {
        try {
            ...
            if (version > FORMAT_VERSION) {
                VSAnalogWarfare.LOGGER.warn("[VSAW] Skipping vehicle setup action format {} (supported {}).",
            ...
            return new VehicleSetupAction(VehicleSetupActionType.valueOf(tag.getString("Type")),
                    ...
                    tag.getFloat("Stiffness"), tag.getDouble("PositionOffsetX"),
                    ...
                    tag.getBoolean("InteractionSneaking"), tag.getInt("TransmitterChannel"),
