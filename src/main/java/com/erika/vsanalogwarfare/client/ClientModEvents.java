...
public final class ClientModEvents {
    ...
    public static void clientSetup(FMLClientSetupEvent event) {
        ...
        event.enqueueWork(() -> {
            VisualizerRegistry.setVisualizer(ModBlockEntities.DECORATION_BEARING.get(),
                    SimpleBlockEntityVisualizer.builder(ModBlockEntities.DECORATION_BEARING.get())
            ...
            VisualizerRegistry.setVisualizer(ModBlockEntities.MOUSE_AIM.get(),
                    SimpleBlockEntityVisualizer.builder(ModBlockEntities.MOUSE_AIM.get())
