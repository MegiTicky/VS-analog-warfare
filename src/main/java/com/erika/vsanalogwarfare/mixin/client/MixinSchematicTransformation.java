 ...
 *
 * Create applies both the camera and schematic positions in one operation, the latter of which
 * does not respect VS ship space.
 */
...
public abstract class MixinSchematicTransformation {
    ...
    private Object redirectTranslate(TransformStack instance, Vec3 orig) {
        ...
        if (ship != null) {
            ...
            VSClientGameUtils.transformRenderWithShip(ship.getTransform(), ms, pos.x, pos.y, pos.z,
